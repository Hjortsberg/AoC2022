...
var monkeys = Parser.Parse(input1);


var monkeyPack = new MonkeyPack(monkeys);
var levelOfMonkeyBusiness = monkeyPack.PlayKeepAway(10000);

Console.WriteLine("Level of monkey business: {0}", levelOfMonkeyBusiness);
